...
const ScholarshipCard = ({
  ...
  // );
  if (scholarship.title !== "link")
    return (
      <div
        className="w-full h-[33rem] border rounded-md shadow-sm p-2 flex flex-col justify-between items-center"
        key={scholarship.id}
      >
        <div className="flex flex-col justify-start items-center">
          ...
          <h4 className="text-sm text-center line-clamp-2">
